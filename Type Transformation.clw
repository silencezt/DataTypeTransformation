...
[General Info]
Version=1
LastClass=CTypeTransformationDlg
LastTemplate=CDialog
NewFileInclude1=#include "stdafx.h"
NewFileInclude2=#include "Type Transformation.h"

ClassCount=2
Class1=CTypeTransformationApp
Class2=CTypeTransformationDlg

ResourceCount=2
Resource1=IDR_MAINFRAME
Resource2=IDD_TYPETRANSFORMATION_DIALOG

[CLS:CTypeTransformationApp]
Type=0
HeaderFile=Type Transformation.h
ImplementationFile=Type Transformation.cpp
Filter=N

[CLS:CTypeTransformationDlg]
Type=0
HeaderFile=Type TransformationDlg.h
ImplementationFile=Type TransformationDlg.cpp
Filter=D
LastObject=IDC_COMBO_ANSIUNICODE
BaseClass=CDialog
VirtualFilter=dWC
